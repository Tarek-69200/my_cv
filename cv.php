...
<body class="w3-light-grey">
    ...
    <div id="intro" class="w3-container w3-padding-64 w3-center w3-animate-opacity">
        <div class="w3-container">
            ...
            <h1>COMPÉTENCES TECHNIQUES & PROJETS</h1>
            <p>
                TAGUINE Tarek<br>
    ...
    <div id="one" class="w3-row-padding w3-padding-64">
        ...
        <div class="w3-row-padding w3-padding-64">
            <div class="w3-container">
                ...
                <ul>
                    <li>Je travaille en méthode agile, je suis très à l'écoute et je m'adapte.</li>
                    <li>Je suis très réactif et je suis disponible pour répondre à toutes questions.</li>
                    <li>Je suis très rigoureux dans mon travail et je m'assure que le code soit propre et bien
                        documenté.</li>
                </ul>
        ...
        <div id="three" class="w3-row-padding w3-padding-32">
            ...
            <div class="w3-container">
                ...
                <p>Vous avez un projet ou une question ? N'hésitez pas à me contacter en remplissant le formulaire
                    ci-dessous.
