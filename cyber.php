...
<body class="w3-light-grey">
  ...
  <div id="intro" class="w3-container w3-padding-64 w3-center w3-animate-opacity">
    <div class="w3-container">
      ...
      <p>
      Passionné par le monde de l'Open Source, j'ai décidé de me spécialiser dans l'administration système.
  ...
  <div id="one" class="w3-row-padding w3-padding-64">
    ...
    <div class="w3-row-padding w3-padding-64">
      <div class="w3-container">
      <h2>Back-End</h2>
      <p>Les technologies Back-End que j'utilise notamment dans le développement d'API REST.</p>
            <ul>
              <li>Node.js</li>
              <li>PHP Symfony</li>
              <li>Express.JS</li>
        ...
        <h2>DevOps</h2>
            <ul>
              ...
              <li><a href="https://docs.oracle.com/en-us/iaas/Content/devops/using/home.htm">En savoir plus sur le
                  DevOps</a></li>
            </ul>

         <h2>DevSecOps</h2>
            <ul>
              <li>Automatisation de la sécurité</li>
              <li>Tests de sécurité automatisés</li>
              <li>Intégration de la sécurité dans le cycle de vie du développement</li>
              <li>Formation à la sécurité</li>
              <li>Conformité réglementaire</li>
              <li><a href="https://www.owasp.org/index.php/DevSecOps">En savoir plus sur le DevSecOps</a></li>
            </ul>
